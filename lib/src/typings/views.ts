...
export type IncludeType<TypeParams, ReturnParams = unknown> = ComponentType<
    TypeParams,
    ReturnParams
>;

export type LayoutType<TypeParams, ReturnParams> = ComponentType<
    TypeParams,
    ReturnParams
>;
...
export type HeroType<TypeParams = {}, ReturnParams = unknown> = ComponentType<
    TypeParams,
    ReturnParams
>;
