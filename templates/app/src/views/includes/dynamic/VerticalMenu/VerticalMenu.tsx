export default function VerticalMenu() {
    return (
        <div className="lg:block navbar-menu relative z-50 w-1/3">
            <nav className="fixed top-0 left-0 bottom-0 w-1/6 max-w-xxs flex flex-col h-full py-8 px-4 bg-gray-700 overflow-auto">
                <div className="mb-6">
