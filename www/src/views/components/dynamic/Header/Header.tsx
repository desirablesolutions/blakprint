export default function Header() {
    return (
        <section className="fixed backdrop-blur-lg bg-black bg-opacity-30 top-0 w-full z-50 text-white font-mono">
                    ...
                    <div className="flex items-center justify-between relative">
                        ...
                        <div className="hidden lg:block ml-14">
                            <ul className="inline-flex">
                                <li className="mr-8">
                                    <a
                                        className="inline-block font-bold hover:text-gray-900"
                                        aria-current="page"
                                        href="#"
                                    >
                                        Home
                        ...
                        <div className="hidden lg:block ml-auto">
                            <a className="inline-block mr-8 font-bold" href="#">
                                Log In
                            </a>
                            <a
            ...
            <div
                className="hidden navbar-menu fixed top-0 left-0 bottom-0 w-3/4 max-w-xs z-50"
                data-config-=""
            >
                ...
                <nav className="relative flex flex-col h-full p-8 bg-white">
                    ...
                    <div>
                        <ul>
                            <li className="py-3">
                                <a className="inline-block font-bold hover:text-gray-900" href="#">
                                    Home
                                </a>
                            </li>
                            <li className="py-3">
                    ...
                    <div className="mt-auto">
                        <div>
                            <a className="block py-3 text-center font-bold" href="#">
                                Log In
                            </a>
                            <a
